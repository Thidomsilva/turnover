...
function criarUsuarios() {
    return __awaiter(this, void 0, void 0, function () {
        var usuarios, _i, usuarios_1, usuario;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(_i < usuarios_1.length)) return [3 /*break*/, 4];
                    usuario = usuarios_1[_i];
                    return [4 /*yield*/, (0, firestore_1.addDoc)((0, firestore_1.collection)(db, 'users'), usuario)];
                case 2:
                    _a.sent();
                    console.log("Usu\u00E1rio ".concat(usuario.email, " criado."));
                    _a.label = 3;
                case 3:
                    _i++;
                    return [3 /*break*/, 1];
